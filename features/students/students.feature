...
Scenario: i can edit a student
    Given the following students exist
    | first_name | last_name | grade  | institute | dob        | course_type | number_of_years_in_collage |
    | first2     | last2     | second | school1   | 20/01/2008 | accounting  | 3                          |
    | first1     | last1     | first  | school2   | 20/03/2007 | consultancy | 2                          |
    When I view the list of students
    And I choose to view the student "first1 last1"
